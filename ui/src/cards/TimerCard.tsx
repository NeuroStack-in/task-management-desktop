import { Check, ChevronDown, FolderKanban, ListChecks, Play, Square } from "lucide-react";
      ...
      <CardContent className="flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            disabled={!selected}
            className="ml-auto h-9 shrink-0 gap-1.5 rounded-xl border-transparent bg-white/15 text-feature-foreground ring-1 ring-inset ring-white/15 hover:bg-white/25"
          >
